...
/*
 1)
 */
bool playRecord(int recordName, int recordGenre)
...
/*
 5)
 */
displaySprite(int positionX, int positionY, int spriteType)
{
...
/*
 6)
 */
chooseVolume(int roomNumber, float averageVolume)
...
/*
 7)
 */
walkDog(bool yes, float distance)
...
/*
 8)
 */
createRemix(int track1, int track2, float finishedTempo)
{
...
/*
 10)
 */
doPushups(int numPushups, int speed, bool withWeights)
